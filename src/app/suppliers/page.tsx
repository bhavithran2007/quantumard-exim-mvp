        ...
        <div className="fixed inset-0 bg-black/40 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg shadow-xl w-full max-w-md p-4">
            ...
            <div className="space-y-3">
              {[["Contact",viewSupplier.contactPerson],["Email",viewSupplier.email],["Phone",viewSupplier.phone],["MOQ",viewSupplier.moq],["Lead Time",viewSupplier.leadTime],["Categories",viewSupplier.categories.join(", ")]].map(([k,v])=>(
